...
<?php $form=$this->beginWidget('UniActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->checkBox($model,'active',array('uncheckValue' => 0,"checked" => true)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'searchable'); ?>
		<?php echo $form->checkBox($model,'searchable',array('uncheckValue' => 0,"checked" => true)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'parent_zone_name'); ?>
