	  ...
	  elem.bind({
        "focus.uniform": function(){
			$(".jFormComponent").each(function (e) {
				...
				if($("#"+identifier+" .errorMessage").html()) {
					...
					if($(divHighlight).attr("id") == identifier) {
        ...
        "blur.uniform": function(){
			$(".jFormComponent").each(function (e) {
				var identifier = $(this).attr("id");
				var divHighlight = elem.parent();
				divHighlight.removeClass("jFormComponentHighlight");
				if(divHighlight.attr("id") == identifier && elem.attr("value") != "") {
					divHighlight.removeClass("jFormComponentErrorHighlight");
					$("#"+identifier).children().removeClass("error");
					$("#"+identifier+" .errorMessage").remove();
					$("#"+identifier+"_error .jFormerTip").remove();
				}
			});
        }
      });	
